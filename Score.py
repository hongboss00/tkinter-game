...
class Score():
    ...
    def __init__(self, tk, canvas):
        ...
        self.text = StringVar()
        self.users = {'UNKNOWN' : 0, 'UNKNOWN2' : 0, 'UNKNOWN3' : 0, 'UNKNOWN4' : 0, 'UNKNOWN5' : 0,
        ...
        self.b2 = Button(self.root, text = 'RESTART!', command = self.clicked, 
            width = 10, height = 3, bg = 'white')
    ...
    def show(self):
        if not self.btn_clicked:
            ...
            self.mcanvas.create_window(800, 250, window = self.b2)
    ...
    def getrestart(self):
        return self.restart
    def setrestart(self, whether):
        self.restart = whether